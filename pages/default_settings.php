...
$wp_timeline_12_options ['responsive_settings'] = array (
    'responsive-years'=>array(
        'type'=>'checkbox',
        'title' => __( "Disable node text:", 'my_content_timeline' ),
        'tooltip' => __( "Disable node text on small resolutions", 'my_content_timeline' ),
        'default'=>0,
    ),
);
$wp_timeline_12_options ['search_settings'] = array (
    'activate-search'=>array(
        'type'=>'checkbox',
        'title' => __( "Activate search bar:", 'my_content_timeline' ),
        'tooltip' => __( "Activate/disable search bar", 'my_content_timeline' ),
        'default'=>0,
    ),
    'hide-show-search' => array ( // old
        'type' => 'select',
        'title' => __ ( "Style:", 'my_content_timeline' ),
        'tooltip' => __ ( "Choose style for search bar", 'my_content_timeline' ),
        'default' => $settings ['hide-show-search'],
        'values' => array (
            'visible' => __ ( "Visible", 'my_content_timeline' ),
            'hidden' => __ ( "Hidden", 'my_content_timeline' )
        )
    ),
    'search-bar-position' => array (
        'type' => 'select',
        'title' => __ ( "Search bar position", 'my_content_timeline' ),
        'default' => $settings ['search-bar-position'],
        'tooltip' => __ ( "Choose position for search bar" ),
        'values' => array (
            'top' => __ ( "Top", 'my_content_timeline' ),
            'center' => __ ( "Center", 'my_content_timeline' ),
            'bottom' => __ ( "Bottom", 'my_content_timeline' )
        )
    ),
);
...
$wp_timeline_12_options ['text_settings']=array(
	'my_line_1'=>array(
		'type' => 'my_line_1',
		'title' => __ ( "TITLE:", 'my_content_timeline' )		//shindiri studio
	),
	...
	'my_line_2'=>array(
				'type' => 'my_line',
				'title' => __ ( "TEXT:", 'my_content_timeline' ) //shindiri studio
	),
		...
		'my_line_5'=>array(
				'type' => 'my_line',
				'title' => __ ( "OPEN TITLE:", 'my_content_timeline' ) //shindiri studio
		),
		...
		'my_line_6'=>array(
				'type' => 'my_line',
				'title' => __ ( "OPEN TEXT", 'my_content_timeline' ) //shindiri studio
		),
...
$wp_timeline_12_options ['card_settings'] = array (
		'my_line_1' => array (
				'type' => 'my_line_1',
				'title' => __ ( "DEFAULT VIEW:", 'my_content_timeline' ) //shindiri studio
		)
		,
		'item-width' => array (
				'type' => 'text',
		...
		'my_line_2' => array (
				'type' => 'my_line',
				'title' => __ ( "ACTIVE VIEW:", 'my_content_timeline' ) //shindiri studio
		)
		,
...
$wp_timeline_12_options ['global_settings'] = array (
		...
		'style' => array (
				'type' => 'select',
				'title' => __ ( "Choose Timeline Style:", 'my_content_timeline' ),
				'tooltip' => __ ( "Set Global style options", 'my_content_timeline' ),
				'values' => $wp_my_timeline_styles
		),
		'vertical' => array (
				'type' => 'checkbox',
				'title' => __ ( "Activate Vertical Timeline:", 'my_content_timeline' ),/*shindiri studio*/
		...
		'latest-post-start-item' => array (
				'type' => 'checkbox',
				'title' => __ ( "Set Latest Post as Starting:", 'my_content_timeline' ),/*shindiri studio*/
				'tooltip' => __ ( "If this option is enabled, start item will be latest post.", 'my_content_timeline' ),
				'default' => 0 
		),
		'load-post-dynamic' => array (
				'type' => 'checkbox',
				'title' => __ ( "Add posts dinamically:", 'my_content_timeline' ),/*shindiri studio*/
		...
		'autoplay' => array (
				'type' => 'checkbox',
				'title' => __ ( "Enable Autoplay:", 'my_content_timeline' ),/*shindiri studio*/
				'tooltip' => __ ( "If this option is enabled, slider will autoplay", 'my_content_timeline' ),
				'default' => 0 
		),
		'autoplay-mob' => array (
				'type' => 'checkbox',
				'title' => __ ( "Enable Autoplay on Mobile:", 'my_content_timeline' ),/*shindiri studio*/
				'tooltip' => __ ( "If this option is enabled, slider will autoplay for mobile devices", 'my_content_timeline' ),
				'default' => 0 
		),
		'autoplay-step' => array (
				'type' => 'text',
				'title' => __ ( "Autoplay Delay:", 'my_content_timeline' ),/*shindiri studio*/
		...
		'my_line' => array (
				'type' => 'my_line',
				'title' => __ ( "CHRONOLOGICAL OPTIONS:", 'my_content_timeline' )//shindiri studio
		),
		...
		'cat-type' => array ( // old
				'type' => 'select',
				'title' => __ ( "Choose Timeline Type:", 'my_content_timeline' ),/*shindiri studio*/
				...
				'values' => array (/*shindiri studio*/
						'months' => __ ( "Group by Months", 'my_content_timeline' ),
						"categories" => __ ( "Group by Categories", 'my_content_timeline' ),
						"years" => __ ( "Group by Years", 'my_content_timeline' ),
				) 
		),
		/*shindiri studio*/
        'num-of-years' => array (
                'type' => 'text',
                'title' => __ ( "Years per line:", 'my_content_timeline' ),
                'tooltip' => __ ( "Set the number of years to be displayed per line", 'my_content_timeline' ),
                'default' => '9',
                'size'=>5
        ),
		'my_line_1' => array (
				'type' => 'my_line',
				'title' => __ ( "GLOBAL CARD SETTINGS:", 'my_content_timeline' )//shindiri studio
		),
        'read-more' => array ( // old
         'type' => 'select',
         'title' => __ ( "Read More Type:", 'my_content_timeline' ),//shindiri studio
		...
		'item-margin' => array ( // old
				'type' => 'text',
				'title' => __ ( "Card Margin:", 'my_content_timeline' ),//shindiri studio
		...
		'item-height' => array ( // old
				'type' => 'text',
				'title' => __ ( "Card Height:", 'my_content_timeline' ),//shindiri studio
		...
		'align-start-item' => array ( // old
                'type' => 'select',
                'title' => __ ( "Start Item Alignment:", 'my_content_timeline' ),
		...
		'my_line_2' => array ( // old
				'type' => 'my_line',
				'title' => __ ( "TIMELINE SETTINGS:", 'my_content_timeline' ) //shindiri studio
		),
		'hide-line' => array (
				'type' => 'checkbox',
        ...
        'fast-forward-backward' => array (
            'type' => 'checkbox',
            'title' => __ ( "Fast forward/backward:", 'my_content_timeline' ),
            'tooltip' => __ ( "Enable icons to quickly move from first to last item and backwards", 'my_content_timeline' ),
            'default' => $settings ['fast-forward-backward']
        ),
		'line-style' => array (
				'type' => 'select',
				'title' => __ ( " Choose Line Style:", 'my_content_timeline' ), //shindiri studio
		...
		'nav-style' => array (
				'type' => 'select',
				'title' => __ ( "Choose Navigation Style:", 'my_content_timeline' ), //shindiri studio
		...
		'shadow' => array (
				'type' => 'select',
				'title' => __ ( "Choose Shadow Option:", 'my_content_timeline' ), // shindiri studio
